...
const shopCounterEl = document.querySelector('.cartIconWrap span');
...
function addToCard(id, name, price) {
    ...
    basket[id].count++;
    shopCounterEl.textContent = getTotalShopCount().toString();
    basketTotalValueEl.textContent = getTotalShopPrice().toFixed(2);
    renderProductInBasket(id);
}

function getTotalShopPrice() {
